...
@section('title', 'Admin - Quản lý nhập giống')
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Danh sách hóa đơn nhập giống</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item">Quản lý nhập</li>
            <li class="breadcrumb-item active">Quản lý nhập giống</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <tbody id="dataTable">
            ...
            ?>
              <tr class="text-center">
                <td class="align-middle"><?= $seed->STTPNCG ?></td>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Thông tin con giống</h4>
