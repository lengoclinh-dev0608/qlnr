...
@section('title', 'Admin - Quản lý danh mục bệnh')
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Quản lý danh mục bệnh</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Quản lý danh mục</li>
            <li class="breadcrumb-item active">Danh mục bệnh</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <tbody id="dataTable">
            ...
            ?>
              <tr class="text-center">
                <td class="align-middle"><?= $sick->BENH_ID ?></td>
                <td class="align-middle"><?= $sick->TEN_BENH ?></td>
                <td class="align-middle"><?= $sick->TRIEU_CHUNG ?></td>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">danh mục bệnh mới</h4>
