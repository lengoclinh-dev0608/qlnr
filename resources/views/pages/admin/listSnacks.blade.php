...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Danh sách lứa rắn</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Danh sách lứa rắn</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <table id="example2" class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th class="text-center">Ngày nuôi</th>
              <th class="text-center">Ngày thay nước định kỳ</th>
              <th class="text-center">Lượng nước</th>
              <th class="text-center">Chất lượng nước</th>
          ...
          <tbody id="dataTable">
            ...
            ?>
              <tr class="text-center">
                <td class="align-middle"><?= $snack->LUARAN_ID ?></td>
                <td class="align-middle"><?= $snack->NGAYNUOI ?></td>
                <td class="align-middle"><?= $snack->DINHKYTHAYNUOC ?></td>
                <td class="align-middle"><?= $snack->LUONGNUOC ?></td>
                <td class="align-middle"><?= $snack->CHATLUONGNUOC ?></td>
                <td class="align-middle"><?= $snack->THONGTINKHAC ?></td>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Thông tin lứa rắn</h4>
