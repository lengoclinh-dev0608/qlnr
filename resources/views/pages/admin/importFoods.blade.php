          ...
          <tbody id="dataTable">
            ...
            ?>
              <tr class="text-center">
                <td class="align-middle"><?= $food->STTPNTA ?></td>
                <td class="align-middle"><?= $food->THUCAN_ID ?></td>
                <td class="align-middle"><?= $food->NGAY ?></td>
                <td class="align-middle"><?= $food->SOLUONG ?></td>
                <td class="align-middle"><?= $food->DONGIA ?></td>
                <td class="align-middle"><?= $food->NV_ID ?></td>
