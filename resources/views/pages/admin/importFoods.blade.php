...
@section('title', 'Admin - Quản lý nhập thức ăn')
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Danh sách hóa đơn nhập thức ăn</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item">Quản lý nhập</li>
            <li class="breadcrumb-item active">Quản lý nhập thức ăn</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <table id="example2" class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th class="text-center">Thức ăn</th>
          ...
          <tbody id="dataTable">
            ...
            ?>
              <tr class="text-center">
                <td class="align-middle"><?= $food->pnta->STT_PNTA ?></td>
                <td class="align-middle"><?= $food->thucan->TENTHUCAN ?></td>
                <td class="align-middle"><?= $food->pnta->NGAYNHAP ?></td>
                <td class="align-middle"><?= $food->SOLUONG ?></td>
                <td class="align-middle"><?= number_format($food->DONGIA, 0, ",", ".") . " vnđ" ?></td>
                <td class="align-middle"><?= number_format($food->SOLUONG * $food->DONGIA, 0, ",", ".") . " vnđ" ?></td>
                <td class="align-middle"><?= $food->pnta->nhanvien->NV_HO . " " . $food->pnta->nhanvien->NV_TEN ?></td>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Thông tin con thức ăn</h4>
        ...
        btnSaveEdit.onclick = function() {
          ...
          fetch(url, {
            ...
            .then((data) => {
              ...
              document.querySelector('#btnClofoodit').click();
              // bookInput.value = '';
              reload();
